...
if(function_exists("register_field_group"))
{
  register_field_group(array (
    ...
    'fields' => array (
      ...
      array (
        'key' => 'field_event_newsletter',
        'label' => 'Include in newsletter',
        'name' => 'g2c2-event_newsletter',
        'type' => 'true_false',
        'instructions' => 'Select to include this in a newsletter.',
        'required' => 0,
        'message' => '',
        'default_value' => 0,
      ),
      array (
        'key' => 'field_event_been_newsletter',
        'label' => 'Whether been in newsletter',
        'name' => 'g2c2-event_been_newsletter',
        'type' => 'true_false',
        'instructions' => 'Whether this has been in the newsletter',
        'required' => 0,
